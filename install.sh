...
install_XrayR() {
    ...
    file="https://github.com/nrsxs/XrayR-V2Board/raw/main/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/nrsxs/XrayR-V2Board/master/XrayR.sh
    ...
    # Writing json
    echo "正在尝试写入配置文件..."
    wget https://cdn.jsdelivr.net/gh/nrsxs/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
